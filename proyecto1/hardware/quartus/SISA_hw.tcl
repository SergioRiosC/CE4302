...
add_fileset_file vector_alu.sv SYSTEM_VERILOG PATH ../rtl/core/vector_alu.sv
...
add_interface_port control reset_vector_addr reset_vector_addr Input 32


# 
# connection point cpureg_reset
# 
add_interface cpureg_reset reset end
set_interface_property cpureg_reset associatedClock clock
set_interface_property cpureg_reset synchronousEdges NONE
set_interface_property cpureg_reset ENABLED true
set_interface_property cpureg_reset EXPORT_OF ""
set_interface_property cpureg_reset PORT_NAME_MAP ""
set_interface_property cpureg_reset CMSIS_SVD_VARIABLES ""
set_interface_property cpureg_reset SVD_ADDRESS_GROUP ""

add_interface_port cpureg_reset s_reset reset Input 1


# 
# connection point cpureg_s1
# 
add_interface cpureg_s1 avalon end
set_interface_property cpureg_s1 addressUnits SYMBOLS
set_interface_property cpureg_s1 associatedClock clock
set_interface_property cpureg_s1 associatedReset cpureg_reset
set_interface_property cpureg_s1 bitsPerSymbol 8
set_interface_property cpureg_s1 burstOnBurstBoundariesOnly false
set_interface_property cpureg_s1 burstcountUnits WORDS
set_interface_property cpureg_s1 explicitAddressSpan 64
set_interface_property cpureg_s1 holdTime 0
set_interface_property cpureg_s1 linewrapBursts false
set_interface_property cpureg_s1 maximumPendingReadTransactions 0
set_interface_property cpureg_s1 maximumPendingWriteTransactions 0
set_interface_property cpureg_s1 readLatency 1
set_interface_property cpureg_s1 readWaitStates 0
set_interface_property cpureg_s1 readWaitTime 0
set_interface_property cpureg_s1 setupTime 0
set_interface_property cpureg_s1 timingUnits Cycles
set_interface_property cpureg_s1 writeWaitTime 0
set_interface_property cpureg_s1 ENABLED true
set_interface_property cpureg_s1 EXPORT_OF ""
set_interface_property cpureg_s1 PORT_NAME_MAP ""
set_interface_property cpureg_s1 CMSIS_SVD_VARIABLES ""
set_interface_property cpureg_s1 SVD_ADDRESS_GROUP ""

add_interface_port cpureg_s1 s1_address address Input 6
add_interface_port cpureg_s1 s1_read read Input 1
add_interface_port cpureg_s1 s1_readdata readdata Output 32
add_interface_port cpureg_s1 s1_write write Input 1
add_interface_port cpureg_s1 s1_writedata writedata Input 32
set_interface_assignment cpureg_s1 embeddedsw.configuration.isFlash 0
set_interface_assignment cpureg_s1 embeddedsw.configuration.isMemoryDevice 0
set_interface_assignment cpureg_s1 embeddedsw.configuration.isNonVolatileStorage 0
set_interface_assignment cpureg_s1 embeddedsw.configuration.isPrintableDevice 0


# 
# connection point cpureg_s2
# 
add_interface cpureg_s2 avalon end
set_interface_property cpureg_s2 addressUnits SYMBOLS
set_interface_property cpureg_s2 associatedClock clock
set_interface_property cpureg_s2 associatedReset cpureg_reset
set_interface_property cpureg_s2 bitsPerSymbol 8
set_interface_property cpureg_s2 burstOnBurstBoundariesOnly false
set_interface_property cpureg_s2 burstcountUnits WORDS
set_interface_property cpureg_s2 explicitAddressSpan 64
set_interface_property cpureg_s2 holdTime 0
set_interface_property cpureg_s2 linewrapBursts false
set_interface_property cpureg_s2 maximumPendingReadTransactions 0
set_interface_property cpureg_s2 maximumPendingWriteTransactions 0
set_interface_property cpureg_s2 readLatency 1
set_interface_property cpureg_s2 readWaitStates 0
set_interface_property cpureg_s2 readWaitTime 0
set_interface_property cpureg_s2 setupTime 0
set_interface_property cpureg_s2 timingUnits Cycles
set_interface_property cpureg_s2 writeWaitTime 0
set_interface_property cpureg_s2 ENABLED true
set_interface_property cpureg_s2 EXPORT_OF ""
set_interface_property cpureg_s2 PORT_NAME_MAP ""
set_interface_property cpureg_s2 CMSIS_SVD_VARIABLES ""
set_interface_property cpureg_s2 SVD_ADDRESS_GROUP ""

add_interface_port cpureg_s2 s2_address address Input 6
add_interface_port cpureg_s2 s2_read read Input 1
add_interface_port cpureg_s2 s2_readdata readdata Output 32
add_interface_port cpureg_s2 s2_write write Input 1
add_interface_port cpureg_s2 s2_writedata writedata Input 32
set_interface_assignment cpureg_s2 embeddedsw.configuration.isFlash 0
set_interface_assignment cpureg_s2 embeddedsw.configuration.isMemoryDevice 0
set_interface_assignment cpureg_s2 embeddedsw.configuration.isNonVolatileStorage 0
set_interface_assignment cpureg_s2 embeddedsw.configuration.isPrintableDevice 0
